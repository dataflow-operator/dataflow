...
func TestArrowTypeForIceberg(t *testing.T) {
...
func TestInferFlattenColumnTypes_OffsetInt32(t *testing.T) {
	...
	cols := []string{"kafka_offset"}
	typesMap := inferFlattenColumnTypes([]*types.Message{msg}, cols, "kafka_")
	assert.Equal(t, "int", typesMap["kafka_offset"].Type())
}
